    ...
    if(fichier)  // si l'ouverture a réussi
    {
        ...
        while(getline(fichier, ligne))  // tant que l'on peut mettre la ligne dans "contenu"
        {
            ...
            if (vstrings.size() > 0 && vstrings[0] == "f"){
                ...
                line((1.+(float)strtof((point1[1]).c_str(),0))*400, (1.+(float)strtof((point1[2]).c_str(),0))*400, (1.+(float)strtof((point2[1]).c_str(),0))*400, (1.+(float)strtof((point2[2]).c_str(),0))*400, image, white);

                line((1.+(float)strtof((point2[1]).c_str(),0))*400, (1.+(float)strtof((point2[2]).c_str(),0))*400, (1.+(float)strtof((point3[1]).c_str(),0))*400, (1.+(float)strtof((point3[2]).c_str(),0))*400, image, white);

                line((1.+(float)strtof((point3[1]).c_str(),0))*400, (1.+(float)strtof((point3[2]).c_str(),0))*400, (1.+(float)strtof((point1[1]).c_str(),0))*400, (1.+(float)strtof((point1[2]).c_str(),0))*400, image, white);
